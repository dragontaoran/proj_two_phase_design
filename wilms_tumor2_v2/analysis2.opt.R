...
#### opt
martingale_residual = coxph(Surv(edrel, rel)~stage2+stage3+stage4+age, data=dat)$residuals
...
dat1 = dat
dat1$uh[-phase2] = NA
res_opt = smle(Y="edrel", Delta="rel", X="uh", Z=c("stage2","stage3","stage4","age"), 
               Bspline_Z=c("bs1","bs2"), data=dat1, model="coxph", hn_scale=10)
res_opt
